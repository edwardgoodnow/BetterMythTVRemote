...
function hook_css() {
    ?>
     <!-- Included from wp-includes/general-template.php with custom function use this file to add javascript please do not do direct edits to the templates -->
        <style>
            .wp_head_example {
...
function hook_javascript() {
    ?>
        <!-- Included from wp-includes/general-template.php with custom function use this file to add javascript please do not do direct edits to the templates --><script type="text/javascript" src="https://cdn.ywxi.net/js/1.js" async></script>
    <?php
}
